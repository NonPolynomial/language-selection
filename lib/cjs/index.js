...
var LanguageLink = function (_a) {
    ...
    return (React__default['default'].createElement("a", { onClick: onClick, href: lang.url, title: lang.title }, lang.name));
};
...
var LanguageSwitcher = function (_a) {
    ...
    var langSwitchRef = React.useRef(null);
    var _q = React.useReducer(reducer, __assign(__assign({}, initialState), { langs: langs,
    ...
    var highlightedLanguageLinks = state.langs
        ...
        .map(function (lang, index) { return (React__default['default'].createElement("li", { style: { fontWeight: 'bold' }, key: index },
        React__default['default'].createElement(LanguageLink, { onClick: function (e) {
                if (simulate) {
                    e.preventDefault();
                }
                dispatch({
    ...
    var languageLinks = langs
        ...
        .map(function (lang, index) { return (React__default['default'].createElement("li", { key: index },
        React__default['default'].createElement(LanguageLink, { onClick: function (e) {
                if (simulate) {
                    e.preventDefault();
                }
    ...
    return (React__default['default'].createElement("div", { className: classes.join(' '), onClick: function (e) {
            if (!e.isDefaultPrevented()) {
                dispatch({ type: state.opened ? 'close_popup' : 'open_popup' });
            }
        }, ref: langSwitchRef },
        React__default['default'].createElement("div", { className: selectedLangClasses.join(' ') }, selectedLanguage && React__default['default'].createElement(LanguageLink, { lang: selectedLanguage })),
        React__default['default'].createElement("div", { className: selectionContainerClasses.join(' '), style: {
                display: state.opened ? '' : 'none',
            } },
            showInput && (React__default['default'].createElement(React__default['default'].Fragment, null,
                React__default['default'].createElement("input", { className: inputClasses.join(' '), type: "text", onClick: function (e) {
                        e.preventDefault();
                    }, onKeyUp: function (e) {
                        return dispatch({ type: 'filter_langs', langFilter: e.target.value });
                    } }),
                React__default['default'].createElement("span", { className: inputSpanClasses.join(' ') }))),
            React__default['default'].createElement("ul", { className: langSelectionClasses.join(' ') },
